...
from api.v1 import accounts, auth, events, health, logs, neurocomment, warming
...
router.include_router(logs.router, dependencies=_protected)
router.include_router(events.router, dependencies=_protected)
