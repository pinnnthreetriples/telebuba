...
_proxies = Table(
    ...
    Column("geo_status", String, nullable=False, server_default="unknown"),
    Column("ipinfo_country_code", String, nullable=True),
    Column("maxmind_country_code", String, nullable=True),
