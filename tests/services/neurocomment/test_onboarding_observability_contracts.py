...
from services.neurocomment import _onboard_pair, _seams, onboarding
...
async def test_resolve_failure_is_isolated_with_actionable_audit_context(
    ...
    audit = AsyncMock()
    monkeypatch.setattr(_onboard_pair, "_resolve_linked_group", resolve)
    monkeypatch.setattr(_onboard_pair, "log_event", audit)
