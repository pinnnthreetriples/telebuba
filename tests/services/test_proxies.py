...
async def test_check_proxy_persists_complete_result_and_logs_verdict(
    ...
    assert checked.geo_status == "unknown"
    assert checked.ipinfo_country_code is None
    assert checked.maxmind_country_code is None
    ...
    assert events == [
        (
            ...
            "proxy_checked",
            {
                ...
                "country_code": "NL",
                "geo_status": "unknown",
                "ipinfo_country_code": None,
                "maxmind_country_code": None,
                "last_error": last_error,
            },
        ),
    ]
