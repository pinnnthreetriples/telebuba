        ...
        <div className="flex flex-col gap-md">
          ...
          <label className="block type-caption font-medium">
            ...
            <input
              ...
              className="mt-tight w-full rounded-lg border border-line bg-surface-card px-md py-md text-body font-normal text-content-primary outline-none focus:border-action-primary"
            />
          </label>
          <label className="block type-caption font-medium">
