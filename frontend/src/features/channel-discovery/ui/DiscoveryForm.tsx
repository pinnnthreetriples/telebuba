    ...
    >
      ...
      <div>
        ...
        <div className="flex items-start gap-sm">
          ...
          <button
            ...
            className="shrink-0 whitespace-nowrap rounded-lg border border-line-input bg-white px-[13px] py-[9px] text-[12.5px] font-medium text-ink-muted transition-colors hover:border-primary hover:text-primary disabled:opacity-50"
          >
            {expand.isPending
        ...
        {topicTooLong ? (
          <p role="status" className="mt-[5px] text-[11px] text-danger">
      ...
      <div className="flex items-center justify-end gap-md pt-[3px]">
        ...
        <button
          ...
          className="rounded-lg bg-primary px-[15px] py-[7px] text-[11px] font-semibold text-white disabled:opacity-50"
        >
          {submitting
